...
public class EducationLoanController {
	...
	public String getEducationLoan(@ModelAttribute("inserEducationLoan") @Valid EducationLoan eduacationLoan,
...
public String initiateEducationLoan(
	@ModelAttribute("inserEducationLoan") @Valid EducationLoan educationLoan,
	BindingResult result, 
	Model model) {
	
	
	//UserDetails userDetails=new UserDetails(1234567890987655l,"Salary", "neha", 5000654);	//userList=new ArrayList<User>();
...
//	new EmployeeValidator().validate(employee, result);
	try {
		...
		service.update(9876543212349860L,educationLoan);
	} 
